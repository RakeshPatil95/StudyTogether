...
//@WebServlet(value = "/validate", loadOnStartup = 1,initParams = {@WebInitParam(name = "url",value = "...")})
public class LoginServlet extends HttpServlet {
	...
	//	System.out.println("ctx="+getServletContext());//NPExc
	}

	public LoginServlet(String mesg) {
		System.out.println("in paramed ctor of  " + getClass() + " config=" + getServletConfig());// null
	}
	...
	public void init() throws ServletException {
		try {
			//How to get servlet specific init params ? using javax.servler.ServletConfig i/f
			ServletConfig config=getServletConfig();
			System.out.println("config="+config);//NON NULL
			System.out.println("ctx="+getServletContext());
			
			openConnection(config.getInitParameter("url"),
