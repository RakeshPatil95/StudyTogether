...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			else // login success --auto navigate the clnt to topics page : in the NEXT request
					// coming from clnt browser
			{
//				pw.print("<h4> Login Successful ! <br/>");
//				pw.println("Your details "+user+"</h4>");
		...
		//		pw.flush();//WC throws IllegalStateExc --can not call sendRedirect after committing the resp !!!!!!!!!!!!
