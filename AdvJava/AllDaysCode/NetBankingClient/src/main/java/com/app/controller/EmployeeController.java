...
import com.app.service.INetBankingClntService;
...
public class EmployeeController {
	...
	@Autowired
	private INetBankingClntService netBankingClntService;
...
//		return  ResponseEntity.ok(empService.saveEmpDetails(emp));
	...
	//add req handling method to get emp's a/c details
	@GetMapping("/{empId}/accounts/{acctNo}")
	public ResponseEntity<?> getEmpBankAccountDetails(@PathVariable int empId,@PathVariable int acctNo)
	{
		System.out.println("emp id acct id "+empId+" "+acctNo);
		//invoke net banking clnt service
		
		return ResponseEntity.ok(netBankingClntService.fetchAccountDetails(empId,acctNo));//resp : his/her a/c details
	}
